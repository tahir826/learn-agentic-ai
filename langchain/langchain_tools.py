...
def get_weather_tool(city: str) -> str:
    ...
    output = requests.get(f"https://api.openweathermap.org/data/2.5/weather?q={city}&appid=API_KEY")    
    return output
...
#     add_numbers_tool,
#     )
# # llm_with_tools=llm.bind_tools([add_numbers_tool])
# # Test the chain with two numbers
# input_numbers = input("enter you numbers :>- ")
# # output = llm_with_tools.invoke(input_numbers)
